...
!function(n) {
    ...
    t.prototype.close = function(t) {
        ...
        n.support.transition && i.hasClass("fade") ? i.on(n.support.transition.end, f) : f())
    }
    ,
    r = n.fn.alert,
...
!function(n) {
    ...
    t.prototype = {
        ...
        slide: function(t, i) {
            var e = this.$element.find(".item.active"), r = i || e[t](), s = this.interval, u = t == "next" ? "left" : "right", h = t == "next" ? "first" : "last", o = this, f;
            if (this.sliding = !0,
            s && this.pause(),
    ...
    n(document).on("click.carousel.data-api", "[data-slide], [data-slide-to]", function(t) {
        var i = n(this), u, r = n(i.attr("data-target") || (u = i.attr("href")) && u.replace(/.*(?=#[^\s]+$)/, "")), e = n.extend({}, r.data(), i.data()), f;
        r.carousel(e),
...
!function(n) {
    ...
    t.prototype = {
        ...
        reset: function(n) {
            ...
            return this.$element.removeClass("collapse")[t](n || "auto")[0].offsetWidth,
        ...
        transition: function(t, i, r) {
            ...
            this.$element[t]("in"),
            n.support.transition && this.$element.hasClass("collapse") ? this.$element.one(n.support.transition.end, f) : f())
        },
        toggle: function() {
    ...
    n(document).on("click.collapse.data-api", "[data-toggle=collapse]", function(t) {
        var i = n(this), u, r = i.attr("data-target") || t.preventDefault() || (u = i.attr("href")) && u.replace(/.*(?=#[^\s]+$)/, ""), f = n(r).data("collapse") ? "toggle" : i.data();
...
!function(n) {
    ...
    var i = "[data-toggle=dropdown]", t = function(t) {
    ...
    t.prototype = {
        ...
        keydown: function(t) {
            ...
            !e.is(".disabled, :disabled"))) {
                ...
                s = o.hasClass("open"),
                !s || s && t.keyCode == 27)
                    return t.which == 27 && o.find(i).focus(),
                    e.click();
                (f = n("[role=menu] li:not(.divider):visible a", o),
                f.length) && (u = f.index(f.filter(":focus")),
                t.keyCode == 38 && u > 0 && u--,
                t.keyCode == 40 && u < f.length - 1 && u++,
                ~u || (u = 0),
                f.eq(u).focus())
            }
        }
    ...
    ,
    n(document).on("click.dropdown.data-api", u).on("click.dropdown.data-api", ".dropdown form", function(n) {
        n.stopPropagation()
    }).on("click.dropdown-menu", function(n) {
        n.stopPropagation()
...
!function(n) {
    ...
    t.prototype = {
        ...
        hide: function(t) {
            ...
            n.support.transition && this.$element.hasClass("fade") ? this.hideWithTransition() : this.hideModal())
        },
        ...
        backdrop: function(t) {
            var u = this, r = this.$element.hasClass("fade") ? "fade" : "", i;
            if (this.isShown && this.options.backdrop) {
                if (i = n.support.transition && r,
                this.$backdrop = n('<div class="modal-backdrop ' + r + '" />').appendTo(document.body),
                this.$backdrop.click(this.options.backdrop == "static" ? n.proxy(this.$element[0].focus, this.$element[0]) : n.proxy(this.hide, this)),
                ...
                n.support.transition && this.$element.hasClass("fade") ? this.$backdrop.one(n.support.transition.end, t) : t()) : t && t()
        }
    },
    i = n.fn.modal,
...
!function(n) {
    ...
    t.prototype = {
        ...
        init: function(t, i, r) {
            ...
            e = f.length; e--; )
                u = f[e],
                u == "click" ? this.$element.on("click." + this.type, this.options.selector, n.proxy(this.toggle, this)) : u != "manual" && (o = u == "hover" ? "mouseenter" : "focus",
        ...
        getOptions: function(t) {
            return t = n.extend({}, n.fn[this.type].defaults, this.$element.data(), t),
        ...
        enter: function(t) {
            var u = n.fn[this.type].defaults, r = {}, i;
        ...
        applyPlacement: function(n, t) {
            var i = this.tip(), s = i[0].offsetWidth, f = i[0].offsetHeight, u, r, e, o;
            i.offset(n).addClass(t).addClass("in"),
            u = i[0].offsetWidth,
            r = i[0].offsetHeight,
            t == "top" && r != f && (n.top = n.top + f - r,
            o = !0),
            t == "bottom" || t == "top" ? (e = 0,
            n.left < 0 && (e = n.left * -2,
            n.left = 0,
            ...
            u = i[0].offsetWidth,
            r = i[0].offsetHeight),
            this.replaceArrow(e - s + u, u, "left")) : this.replaceArrow(r - f, r, "top"),
            o && i.offset(n)
        },
        ...
        hide: function() {
            ...
            !i.isDefaultPrevented())
                ...
                n.support.transition && this.$tip.hasClass("fade") ? r() : t.detach(),
...
!function(n) {
    ...
    t.prototype = n.extend({}, n.fn.tooltip.Constructor.prototype, {
        ...
        getContent: function() {
            var t, i = this.$element, n = this.options;
            return t = (typeof n.content == "function" ? n.content.call(i[0]) : n.content) || i.attr("data-content"),
            t
        },
        tip: function() {
            return this.$tip || (this.$tip = n(this.options.template)),
...
!function(n) {
    "use strict";
    function t(t, i) {
        var u = n.proxy(this.process, this), f = n(t).is("body") ? n(window) : n(t), r;
    ...
    t.prototype = {
        ...
        refresh: function() {
            ...
            i = this.$body.find(this.selector).map(function() {
                var u = n(this)
                  ...
                  , r = /^#\w/.test(i) && n(i);
                return r && r.length && [[r.position().top + (!n.isWindow(t.$scrollElement.get(0)) && t.$scrollElement.scrollTop()), i]] || null
            }).sort(function(n, t) {
                return n[0] - t[0]
            }).each(function() {
        ...
        process: function() {
            var i = this.$scrollElement.scrollTop() + this.options.offset, f = this.$scrollElement[0].scrollHeight || this.$body[0].scrollHeight, e = f - this.$scrollElement.height(), t = this.offsets, r = this.targets, u = this.activeTarget, n;
            if (i >= e)
...
!function(n) {
    ...
    t.prototype = {
        ...
        lookup: function() {
            ...
            !this.query || this.query.length < this.options.minLength ? this.shown ? this.hide() : this : (i = n.isFunction(this.source) ? this.source(this.query, n.proxy(this.process, this)) : this.source,
        ...
        sorter: function(n) {
            for (var i = [], r = [], u = [], t; t = n.shift(); )
                t.toLowerCase().indexOf(this.query.toLowerCase()) ? ~t.indexOf(this.query) ? r.push(t) : u.push(t) : i.push(t);
            return i.concat(r, u)
        },
        ...
        eventSupported: function(n) {
            ...
            return t || (this.$element.setAttribute(n, "return;"),
...
!function(n) {
    ...
    t.prototype.checkPosition = function() {
        if (this.$element.is(":visible")) {
            var o = n(document).height(), f = this.$window.scrollTop(), e = this.$element.offset(), t = this.options.offset, r = t.bottom, u = t.top, s = "affix affix-top affix-bottom", i;
            (typeof t != "object" && (r = u = t),
            typeof u == "function" && (u = t.top()),
            typeof r == "function" && (r = t.bottom()),
            i = this.unpin != null && f + this.unpin <= e.top ? !1 : r != null && e.top + this.$element.height() >= o - r ? "bottom" : u != null && f <= u ? "top" : !1,
            this.affixed !== i) && (this.affixed = i,
            this.unpin = i == "bottom" ? e.top - f : null,
            this.$element.removeClass(s).addClass("affix" + (i ? "-" + i : "")))
        }
    }
    ,
    i = n.fn.affix,
